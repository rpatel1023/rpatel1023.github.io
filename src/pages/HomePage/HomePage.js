                    ...
                    <Col sm={8} style={{display: 'flex', justifyContent: 'center', textAlign: 'center'}}>
                        <div style={{width:'80%'}}>
                            ...
                            <p> 
                                ...
                                I'm also a huge fan of Dota 2 and esports. I've worked at Team Liquid, designed Discord bots for esports communities, and even helped organize NA Dota In-house Leagues. Check out my blog for my biased sports opinions!
                            </p>
                        </div>
                    </Col>
                </Row>
